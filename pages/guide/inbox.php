...
if (!isset($_GET['tourist_id']) || empty($_GET['tourist_id'])) {
    if (!empty($conversationList)) {
        $tourist_ID = $conversationList[0]['other_user_ID'];
        // Redirect to this tourist's conversation
        header("Location: inbox.php?tourist_id=" . $tourist_ID);
        exit();
    } else {
...
$tourist_name = $touristDetails['name_first'] . ' ' . $touristDetails['name_last'];
$tourist_avatar = $touristDetails['profile_picture'] ?? 'https://i.pravatar.cc/100?img=' . $tourist_ID;
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Messages - Tourismo Zamboanga Guide</title>
...
<body>
    <?php include 'includes/aside-dashboard.php'?>
            ...
            <div class="chat-header">
                <div class="chat-header-info">
                    <div class="chat-header-avatar">
                        <img src="<?= htmlspecialchars($tourist_avatar) ?>" alt="<?= htmlspecialchars($tourist_name) ?>">
                    </div>
                    <div class="chat-header-details">
                        <h5><?= htmlspecialchars($tourist_name) ?></h5>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('.conversation-item').on('click', function() {
                ...
                // Load conversation
                window.location.href = 'inbox.php?tourist_id=' + otherUserID;
            });
